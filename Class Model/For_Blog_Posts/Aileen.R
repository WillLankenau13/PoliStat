...
polls_downloaded_date <- "10-23-2022"
...
Past_Results_down <- read_csv("~/R Stuff/PoliStat/Class Model/Aileen_Past_Results_For_BPI.csv")
...
while(today_date >= end_date){
  ...
  write_csv(for_python, eval(paste("~/R Stuff/PoliStat/Class Model/For_Blog_Posts/Aileen_", today_dash, ".csv", sep = "")))
  
  #Writes a csv file with the center and variance for national mood
  write_csv(center_and_variance, eval(paste("~/R Stuff/PoliStat/Class Model/For_Blog_Posts/Aileen_", today_dash, "_National_Mood.csv", sep = "")))
