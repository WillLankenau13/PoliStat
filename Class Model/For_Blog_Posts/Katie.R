...
while(today_date >= end_date){
  ...
  write_csv(for_python, eval(paste("~/R Stuff/PoliStat/Class Model/For_Blog_posts/Katie_", today_dash, ".csv", sep = "")))
  
  #Writes a csv file with the center and variance for national mood
  write_csv(center_and_variance, eval(paste("~/R Stuff/PoliStat/Class Model/For_Blog_posts/Katie_", today_dash, "_National_Mood.csv", sep = "")))
